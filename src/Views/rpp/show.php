<div class="max-w-7xl mx-auto bg-gray-500 text-white rounded-xl p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <?php
        $opr = str_pad($cab['opr_id'] ?? '', 8, "0", STR_PAD_LEFT);
        $backUrl = !empty($opr) && !empty($cab['proceso_nombre'])
            ? "/orden-produccion/procesos/{$opr}/" . urlencode($cab['proceso_nombre'])
        ...
        <a href="/rpp/print/<?= $cab['documento'] ?? '' ?>"
    ...
    <div class="grid grid-cols-6 gap-4 mb-6">
        ...
        <div class="col-span-1">
            <label>OPR</label>
            <input type="text" value="<?= $opr ?>" class="w-full text-black p-2 bg-gray-200" readonly>
        </div>
    ...
    <table class="w-full bg-white text-black rounded">
        ...
        <tbody>
            ...
            <?php if (!empty($det)): ?>
                ...
                <!-- MP: sobrante de material -->
                <?php if (!empty($mp)): ?>
                    <tr class="bg-gray-300 font-semibold">
                        <td colspan="6" class="p-2">RETORNO DE MATERIAL (MP)</td>
                    </tr>
                ...
                <!-- META: producción terminada -->
                <?php if (!empty($meta)): ?>
                    <tr class="bg-gray-300 font-semibold">
                        <td colspan="6" class="p-2">PRODUCCIÓN RECIBIDA (META)</td>
                    </tr>
